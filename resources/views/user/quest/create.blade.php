...
<div class="container">
    ...
    <h1>Create Yout New Quest <a href="{{ url('user/quest')}}" class="btn btn-success pull-right">Back</a></h1>
    <hr/>

    {!! Form::open(['url' => 'user/quest/store', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data']) !!}
